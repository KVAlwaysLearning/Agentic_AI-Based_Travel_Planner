# 🧳 Indica Odyssey Planner v3.0

The **Indica Odyssey Planner** is an intelligent, agentic travel planning assistant that streamlines multi-city travel. By leveraging **LangChain** for autonomous reasoning and **Streamlit** for a responsive user interface, it transforms raw travel preferences into optimized, cost-effective, and weather-aware itineraries.
