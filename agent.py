...
def run_travel_agent(user_prompt: str, callback_log=None) -> dict:
    ...
    system_instruction = (
        "You are an Elite Travel Specialist. For multi-destination trips:\n"
        "1. Identify every city, date, and leg of the journey.\n"
        "2. CALL TOOLS for each destination to find flights and hotels.\n"
        "3. Create a day-by-day log table that includes: Date, City, Flight/Hotel Charges, and Min/Max Temp.\n"
        "4. Output the itinerary using this strict format:\n\n"
        "# ✈️ TRIP PLAN & ITINERARY\n"
        "## 📋 TRIP SUMMARY\n"
        "[Origin, Destinations, Duration, Dates]\n\n"
        "## 🎫 FLIGHT & HOTEL DETAILS\n"
        "(List each flight and hotel selection clearly for each destination)\n\n"
        "## 📅 DAY-BY-DAY EXPENSE & WEATHER LOG\n"
        "| Date | City | Expenses (Flights/Hotel) | Weather (Min/Max °C) |\n"
        "| --- | --- | --- | --- |\n"
        "| [Date] | [City] | ₹[Amount] | [Min]/[Max] |\n\n"
        "## 💰 GRAND TOTAL\n"
