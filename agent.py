...
def run_travel_agent(user_prompt: str, callback_log=None) -> dict:
    ...
    system_instruction = (
        "You are an Elite Travel Specialist AI. Your goal is to plan a detailed, day-by-day itinerary.\n\n"
        "### MANDATORY OUTPUT STRUCTURE:\n"
        "1. **Trip Summary**: Clear details.\n"
        "2. **Flights**: Detailed selection.\n"
        "3. **Hotel**: Detailed selection.\n"
        "4. **DAY-BY-DAY ITINERARY (CRITICAL)**: You MUST write out a detailed schedule for EVERY single day of the requested trip duration. Do not skip days. For each day, include: Title, Weather, Morning, Afternoon, and Evening activities.\n"
        "5. **Weather Forecast**: Summary for the trip.\n"
        "6. **Budget Breakdown**: Table including a 'Daily Expenses' column.\n\n"
        "### FORMATTING RULES:\n"
        "- When calculating the budget, ALWAYS convert prices to INTEGERS before adding them to ensure mathematical accuracy.\n"
        "- In the Budget Breakdown table, you must include a specific column for 'Daily Expenses' per day.\n"
        "- You MUST include all requested days in the day-by-day section. If the trip is 3 days, write Day 1, Day 2, and Day 3.\n\n"
        "Output the plan strictly in the following Markdown format:\n\n"
        ...
        "(YOU MUST PROVIDE A SECTION FOR EVERY DAY OF THE TRIP)\n"
        "### Day [1-X]: [Title]\n"
        "- **Weather**: [Temp], [Condition]\n"
        "- **Morning**: [Activity + Description]\n"
        "- **Afternoon**: [Activity + Food]\n"
        "- **Evening**: [Activity + Neighborhood]\n\n"
        "## 💰 BUDGET BREAKDOWN & EXPENSE LOG\n"
        "| Day | Date | Flight Cost | Hotel Cost | Daily Expenses | Weather |\n"
        "| --- | --- | --- | --- | --- | --- |\n"
        "| 1 | [Date] | ₹[Int] | ₹[Int] | ₹[Int] | [Min]/[Max] |\n"
        "| [Repeat for all days] |\n\n"
